...
app.use(express.json())
    ...
    // const DB =process.env.DB_U
    mongoose.connect('mongodb+srv://iNote:iNote@cluster0.nz8yz9p.mongodb.net/iNote?retryWrites=true&w=majority',{ useNewUrlParser: true, useUnifiedTopology: true  })
